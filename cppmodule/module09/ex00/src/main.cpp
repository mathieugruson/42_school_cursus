...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/24 11:34:40 by mgruson           #+#    #+#             */
/*   Updated: 2023/05/24 14:46:19 by mgruson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool check_value_error(std::string value)
{
	...
	// std::cout << "trim " << strtrim(value).c_str() << "TEST " << endptr << " + " << value << std::endl;
	// std::cout << "endptr[0] " << endptr[0] << std::endl;
	if (endptr[0] != 0)
	{
